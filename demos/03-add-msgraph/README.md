# <a name="how-to-run-the-completed-project"></a><span data-ttu-id="40ea6-101">如何运行已完成的项目</span><span class="sxs-lookup"><span data-stu-id="40ea6-101">How to run the completed project</span></span>
